...
//////////////////////// DOORBELL TMHR /////////////////////////////////////////////////
static const u16 DOORBELL_Service_UUID     = SERVICE_UUID_DOORBELL;
static const u16 DOORBELL_CharUUID      = CHARACTERISTIC_UUID_DOORBELL;
u8 DOORBELL_VAL[8] = {1, 1, 1, 1, 1, 1, 1,1};
static u8 DOORBELL_InCCC[2];
...
////  attribute values
static const u8 BOORBELLVal[5] = {
	CHAR_PROP_READ | CHAR_PROP_NOTIFY,
	U16_LO(DOORBELL_LEVEL_INPUT_DP_H), U16_HI(DOORBELL_LEVEL_INPUT_DP_H),
	U16_LO(CHARACTERISTIC_UUID_DOORBELL), U16_HI(CHARACTERISTIC_UUID_DOORBELL)
};
...
//	{0,ATT_PERMISSIONS_READ, 2,sizeof (my_OtaName),(u8*)(&userdesc_UUID), (u8*)(my_OtaName), 0},
	...
	{4,ATT_PERMISSIONS_READ,2,2,(u8*)(&my_primaryServiceUUID), 	(u8*)(&DOORBELL_Service_UUID), 0},
	{0,ATT_PERMISSIONS_READ,2,sizeof(BOORBELLVal),(u8*)(&my_characterUUID), (u8*)(BOORBELLVal), 0},				//prop
	{0,ATT_PERMISSIONS_READ,2,sizeof(DOORBELL_VAL),(u8*)(&DOORBELL_CharUUID), 	(u8*)(DOORBELL_VAL), 0},	//value
	{0,ATT_PERMISSIONS_RDWR,2,sizeof(DOORBELL_InCCC),(u8*)(&clientCharacterCfgUUID), 	(u8*)(DOORBELL_InCCC), 0}	//value
