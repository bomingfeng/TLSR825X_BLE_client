...
//#define MTU_SIZE_23bye 
#define MTU_SIZE_245bye
...
typedef enum
{
	...
	//// DOORBELL service ////
	/**********************************************************************************************/
	DOORBELL_PS_H, 								//UUID: 2800, 	VALUE: uuid 180f
	DOORBELL_LEVEL_INPUT_CD_H,					//UUID: 2803, 	VALUE:  			Prop: Read | Notify
	DOORBELL_LEVEL_INPUT_DP_H,					//UUID: 2A19 	VALUE: 
	DOORBELL_LEVEL_INPUT_CCB_H,					//UUID: 2902, 	VALUE: 
